...
# NewButton = "xpath=(//div[@id='workbench-header-actions']//button)[5]"#locator updation for release 206
NewButton = "xpath=//div[@data-slot='sidebar-group-content']/li/button"
...
Locator_SubmissionId = "(//div[@role='row'][.//span[text()='Processing']]//span[contains(@id,'cell-lines_of_business')][normalize-space(.)='']//following::span[contains(@id,'cell-current_stage_name') and text()='In Draft']//following::span[contains(@id,'cell-submission_id')])[last()]"
# Locator_SubmissionId = "(//div[@role='row'][.//span[text()='Processing']]//following::span[contains(@id,'cell-current_stage_name') and text()='In Draft']//following::span[contains(@id,'cell-submission_id')])[1]"
...
# ClearanceTab = "xpath=//div//*[@test-id='clearance-header']"Locator changed
ClearanceTab = "xpath=//nav[@aria-label='breadcrumb']//*[text()='Clearance']"
...
EffectiveDate = "xpath=(//button[@test-id='clearance-field-input-btn-Effective Date'])[1]"
...
CancelButtonInSave = "xpath=(//*[text()='Cancel'])[1]"
# ContinueButtonInSave = "xpath=(//button//*[text()='Continue'])[1]"
ContinueButtonInSave = "xpath=(//*[text()='Continue'])[1]"
...
Documents_Logs = "xpath=//a[@test-id='assets-nav-Logs']"
WorkFLow_History = "xpath=//a[@test-id='assets-nav-Workflow History']"
WorkFlowHistoryPage = "xpath=//assets-workflow-history"
...
SanctionScreeningTaskDetails = {"TaskPriority":"xpath=//div[@test-id='task-priority']",
               ...
               "TaskCreatedBy":"xpath=//div[text()='Created by:']//following::span[not(@data-cy='d3-avatar')and contains(@ng-if,'created_by.first_name')]",
                ...
                "AssignedTo":"xpath=//div[@ng-if='!$ctrl.task.assigned_to.email && !$ctrl.task.assigned_to.user_id' or @ng-if='$ctrl.task.assigned_to.email || $ctrl.task.assigned_to.user_id']",#locator update
               "StageBlocking":"xpath=//div[@test-id='task-stageblocking']",
               "CreatedDate":"//div[@test-id='task-created']"
               }
AutoGeneratedTaskDetails = {"TaskPriority":"xpath=//div[@test-id='task-priority']",
               "TaskDueDate":"//div[@test-id='task-duedate']",
               "TaskRemainder":"xpath=//div[@test-id='task-reminder']",
               "TaskCreatedBy":"xpath=//div[text()='Created by:']//following::span[not(@data-cy='d3-avatar')and contains(@ng-if,'created_by.first_name')]",
                # "AssignedTo":"xpath=//div[@ng-if='!$ctrl.task.assigned_to.email && !$ctrl.task.assigned_to.user_id' or @ng-if='$ctrl.task.assigned_to.email || $ctrl.task.assigned_to.user_id']/span",
...
# AttachmentPoint = "xpath=//li[.//div[text()='Attachment Point']]//button"locator changed 30-10-2025
# AttachmentPointInput = "xpath=//li[.//div[text()='Attachment Point']]//input"locator changed 30-10-2025
AttachmentPoint = "xpath=//div[text()='Attachment Point']//following-sibling::div//button"
AttachmentPointInput = "xpath=//div[text()='Attachment Point']//following-sibling::div//input"
# PolicyNumberInInfo = "xpath=//li[.//div[text()='Policy Number']]//button"locator changed 30-10-2025
# PolicyNumberInput = "xpath=//li[.//div[text()='Policy Number']]//input"locator changed 30-10-2025
PolicyNumberInInfo = "xpath=//div[text()='Policy Number']//following-sibling::div//button"
PolicyNumberInput = "xpath=//div[text()='Policy Number']//following-sibling::div//input"
# ClassOfBuisness = "xpath=//li[.//div[text()='Class of Business']]//button"locator changed 30-10-2025
ClassOfBuisness = "xpath=//div[text()='Class of Business']//following-sibling::div//button"
ClassOfBuisnessDropdown = "xpath=//span[text()='"
# PlacementType = "xpath=//li[.//div[text()='Policy Placement Type']]//button"locator changed 30-10-2025
PlacementType = "xpath=//div[text()='Policy Placement Type']//following-sibling::div//button"
PlacementTypeOption = "xpath=//span[text()='"
# MailedDate = "xpath=//li[.//div[text()='Mailed Date']]//button"locator changed 30-10-2025
MailedDate = "xpath=//div[text()='Mailed Date']//following-sibling::div//button"
# FieldsInPolicyInfromation = "xpath=//li[not(@data-slot)][//div]/div[1]" locator changed release 205
FieldsInPolicyInfromation = "xpath=//section[@id='summary-pricing']//div[@data-slot='card-content']/div[1]"
# Not Taken
...
Error_Saving_popup="xpath=(//div[@id='toast-container']//div[text()='Error saving user modifications'])[1]"
...
schemaNotFoundError = "xpath=//i/ancestor::div[contains(text(),'No policy schema data found for submission')]"

# new
Clients_button="xpath=//a[text()='Clients']"
User_button="xpath=//a[text()='Users']"
Search_clients="xpath=//input[@placeholder='Search clients']"
Client_field="xpath=//clients-record[@client='client']"
Email_composer_attachement="xpath=(//div[normalize-space()='EMAIL_COMPOSER_ATTACHMENTS'])[1]"
Email_conmposer_submmion_attachement="xpath=(//div[normalize-space()='EMAIL_COMPOSER_SUBMISSION_ATTACHMENTS'])[1]"
User_Button="xpath=//a[text()='Users']"

Sidebar_Label="xpath=//section[@id='submission-sidebar-labels']//div//span"
 
# clearance2.0
InsuredTabFields = "xpath=//section[@id='clearance-insured']//input"
NameSearchFiled= "xpath=//div[@data-state='open']//input"
SelectExistingValue= "xpath=//div[@role='listbox']//div[text()='"
SelectNewValue= "xpath=//div[@role='listbox']//Span[text()='"
CoverageProduct= "xpath=(//label[text()='Product(s)']//following-sibling::div//button)[1]"
ProductSegmentValue= "xpath=//label[text()='Product Segment(s)']//following-sibling::div//span//span"
ClearanceCompleteButton= "xpath=//section[@id='clearance-form-save']//button"
ClearanceSavedPopup= "xpath=//ol//li//div//div"
SicCodeInputFileds = "xpath=//section[@id='sic-codes']//input"
NAICSCodeInputFileds= "xpath=//section[@id='naics-codes']//input"
enter_detials_button="xpath=(//*[text()='Update Workflow Stage']//following::button//*[normalize-space()='Enter details'])[1]"
Clearance_NaicsCode="xpath=//tbody//tr//td//input[contains(@name,'code')]"
Project_Addresses="xpath=//div[text()='Project Addresses']"
Project_Addresses_Add="xpath=(//div[@data-slot='card-title']//button)[1]"
project_Addres_input="xpath=//input[@name='d3Submission.d3LineOfBusiness.1.exposures.construction.contractor.jobs.0."
project_Addres_field="xpath=//div[@data-slot='card-content']//label"
Vessels="xpath=//div[text()=' Vessels']"
Vessels_Add="xpath=(//div[@data-slot='card-title']//button)[2]"
Vessels_delete="xpath=//div[@data-slot='card-content']//div//button"
...
# new 
Convr_cell_value="xpath=(//div[@role='gridcell' and @col-id='"
Convr_cell_value_suffix="'])[1]"
Convr_cell_column="xpath=//div[@role='gridcell' and @col-id='ag-Grid-SelectionColumn']"
Convr_detials_field="xpath=//div[@role='columnheader']//span[text()='Details']"
Convr_submission_button="xpath=//a[text()='Submissions']"
Submission_Headers="xpath=//span[@class='ag-header-cell-text']"
Transaction_filter_button="xpath=//div[@col-id='transaction_type']//span[@data-ref='eFilterButton']"
Transaction_type_options="xpath=//div[@aria-label='Filter List']//div[@data-ref='eLabel']"
Filter_option_checkbox="xpath=//div[@aria-label='Filter List']//div[ text()='" 
check_box_filter_field="xpath=//input[@aria-label='Search filter values']"
Filter_option_checkbox_suffix="']//following-sibling::div//input"
transaction_type_value="xpath=//div[@role='gridcell' and @col-id='transaction_type']"
Account_filter_button="xpath=//div[@col-id='customer_submission_id']//span[@data-ref='eFilterButton']"
Filter_input="xpath=(//input[@aria-label='Filter Value'])[1]"
filter_apply_button_suffix="']//span[@data-ref='eFilterButton']"
filter_apply_button_prefix="xpath=//div[@col-id='"
Cell_value="xpath=//div[@role='gridcell' and @col-id='"
BROKER_LLM_extraction="xpath=//div[normalize-space()='BROKER_LLM_EXTRACTION']//ancestor::div[1]//preceding-sibling::d3-toggle//button[contains(@class,'pointer bg-gray')]"
Clearnce_effective_Date="xpath=//label[text()='Effective Date']//following-sibling::div[1]//input"
clearance_exp_date="xpath=//label[text()='Expiration Date']//following-sibling::div[1]//input"
...
Remove_filter="xpath=((//div[@class='flex items-center'])[2]//button)[2]"
Coverage_Drop_Down_Value="xpath=//div[@role='listbox']//div//span"
Clearance_remove_Button2="']//ancestor::div[1]//div[contains(@class,'justify-between')])[2]//div[@role='button']"
Clearance_remove_Button1="xpath=(//label[text()='"
